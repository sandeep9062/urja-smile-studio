...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium dental care with state-of-the-art technology, expert dentists and a calm, patient-first experience. Book your appointment today." },
      { name: "author", content: "Urja Dental Clinic" },
